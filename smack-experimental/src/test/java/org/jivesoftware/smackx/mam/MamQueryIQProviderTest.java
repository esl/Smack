...
public class MamQueryIQProviderTest {
    ...
    public void checkMamQueryIQProvider() throws Exception {
        // example 1
        XmlPullParser parser1 = PacketParserUtils.getParserFor(exampleMamQueryIQ1);
        MamQueryIQ mamQueryIQ1 = new MamQueryIQProvider().parse(parser1);
        ...
        // example2
        XmlPullParser parser2 = PacketParserUtils.getParserFor(exampleMamQueryIQ2);
        MamQueryIQ mamQueryIQ2 = new MamQueryIQProvider().parse(parser2);
